...
<c:url var="actionURL" value="/admin/faculty/add"/>
<body>
<section class="vbox">
				...
				<jsp:attribute name="content">
					<section class="vbox">
            			<div class="content padder">
            				<div class="row">
			                <div class="col-sm-12">
			                  <form:form modelAttribute="newFaculty" class="form-horizontal" method="post" action="${actionUrl}">
								<fieldset>
				                    <section class="panel panel-default">
				                      <header class="panel-heading">
				                        <span class="h4"><spring:message code="faculty.add" /></span>
				                      </header>

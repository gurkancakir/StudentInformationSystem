...
# users
insert into User(id,name,surname,email,password,tcNo,active,role_id) values ('1','Gürkan Mustafa','CAKIR','admin@gmail.com','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.','51245853952',b'1','1');
insert into User(id,name,surname,email,password,tcNo,active,role_id) values ('2','Ahmet','EMİN','instructor@gmail.com','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.','51539524576',b'1','2');
insert into User(id,name,surname,email,password,tcNo,active,role_id) values ('3','Mehmet','ÇALIŞ','student@gmail.com','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.','1111111111',b'1','3');
